-- Fix the duplicate function name error
-- Run this in your Supabase SQL editor

-- Drop all existing process_pass_movement functions
...
-- Create the main function with metadata parameter (this is what the Flutter code expects)
...
SELECT 'Single process_pass_movement function created successfully' as status;