...
class BorderMovementService {
    ...
    try {
      ...
      return (response as List).map((item) {
        ...
        return PassMovement.fromJson({
          ...
          'vehicle_year': passData?['vehicle_year'] != null
              ? int.tryParse(passData?['vehicle_year'])
              : null,
      ...
      // If there's an error with the complex query, fall back to mock data
  ...
  static Future<List<PassMovement>> getVehicleMovements(
    ...
    try {
      ...
      return _getMockVehicleHistory(vehicleVin, vehicleRegistrationNumber);
    }
  }
