-- Restore the original pass movement history function (before profile image changes)
...
-- Restore the original function that was working before
-- This should match the original function structure that was working
