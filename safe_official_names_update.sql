-- Safe update to get official names (only if columns exist)

-- First, let's check what columns exist in pass_movements table
-- Run this query first to see available columns:
-- SELECT column_name FROM information_schema.columns WHERE table_name = 'pass_movements' AND table_schema = 'public';
...
-- Create a basic function that works with current structure
-- We'll enhance it once we know the correct column names
